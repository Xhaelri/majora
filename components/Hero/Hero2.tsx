  ...
  const SkeletonImage = ({
    ...
    return (
      <div className="relative w-full md:w-1/2">
        <Link href={href}>
          <div className="aspect-[4/6] md:aspect-auto md:h-screen relative overflow-hidden ">
            {/* Skeleton Loader */}
            {!loaded && (
            ...
            {error ? (
              <div className="absolute inset-0 bg-gray-200 flex items-center justify-center">
                <div className="text-gray-500 text-center">
                  <div className="w-16 h-16 mx-auto mb-2 bg-gray-300  flex items-center justify-center">
