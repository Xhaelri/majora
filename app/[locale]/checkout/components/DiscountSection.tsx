  ...
  return (
    <>
      <div className="bg-white p-6 shadow-sm border">
        <h2 className="text-xl font-semibold mb-4">{t('discountCode')}</h2>
        ...
        {!appliedDiscount ? (
          <div className="flex flex-col sm:flex-row gap-2 items-center">
            ...
            >
              {discountLoading ? t('discount.applying') : t('discount.apply')}
            </button>
          </div>
        ) : (
          <div className="flex items-center justify-between p-3 bg-green-50 border border-green-200">
            <div>
              <span className="text-sm font-medium text-green-800">
                {t('discount.code')} &quot;{appliedDiscount.code}&quot; {t('discount.applied')}
              </span>
              <p className="text-xs text-green-600">
                {t('discount.youSaved')} {formatPrice(appliedDiscount.amount)}
              </p>
            </div>
            <button
